...
class ParticleClient:
    ...
    def __init__(self, config: Optional[Config] = None):
        ...
        if not self.access_token:
            raise APIError("PARTICLE_ACCESS_TOKEN not found in configuration. Please add it to your .env file.")
    ...
    def call_function(self, device_id: str, function_name: str, argument: str = "", 
                     session: Optional[requests.Session] = None) -> Tuple[bool, Any, bool]:
    ...
    def wait_for_device_online(self, device_id: str, timeout: int = 120, 
        ...
        logger.error(f"Device {device_id} did not come back online within {timeout} seconds")
        return False
