...
2. update configuration uses a wrapper on old GitLogger class. I just want to migrate to using core GitLogger class
...
5. every module has multiple cli paramter definitions for some reason.
