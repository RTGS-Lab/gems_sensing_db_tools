...
def test_get_available_parameters(sample_sensor_data):
    ...
    assert 'Data.Devices.1.Pressure' in node_002_params or 'Diagnostic.Battery.Voltage' in node_002_params
...
def test_extract_time_series_data_no_parsed_messages():
    ...
    with pytest.raises(ValidationError, match="DataFrame must have 'parsed_message' column"):
